...
public final class ClassName extends TypeName implements Comparable<ClassName> {
	...
	public ClassName withoutAnnotations() {
		...
		ClassName resultEnclosingClassName = enclosingClassName != null ? enclosingClassName.withoutAnnotations() : null;
	...
	/**
	 * Returns the enclosing class, like {@link Map} for {@code Map.Entry}. Returns
	 * null if this class is not nested in another class.
	 */
	 ...
	 * {@link #enclosingClassName()} until the result's enclosing class is null.
	 */
	...
	public String reflectionName() {
		return enclosingClassName != null ? (enclosingClassName.reflectionName() + '$' + simpleName) : (packageName.isEmpty() ? simpleName : packageName + '.' + simpleName);
	}
	 ...
	 * {@code enclosingClassName().nestedClass(name)}. Otherwise it is equivalent to
	 * {@code get(packageName(), name)}.
	 */
	...
	/**
	 * Returns a new {@link ClassName} instance for the specified {@code name} as
	 * nested inside this class.
	 */
	...
	/**
	 * Returns a class name created from the given parts. For example, calling this
	 * with package name {@code "java.util"} and simple names {@code "Map"},
	 * {@code "Entry"} yields {@link Map.Entry}.
	 */
