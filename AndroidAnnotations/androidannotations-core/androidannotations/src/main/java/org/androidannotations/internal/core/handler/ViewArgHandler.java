...
public class ViewArgHandler extends BaseAnnotationHandler<EViewGroupHolder> implements MethodInjectionHandler<EViewGroupHolder>, MethodInjectionHandler.AfterAllParametersInjectedHandler<EViewGroupHolder> {
