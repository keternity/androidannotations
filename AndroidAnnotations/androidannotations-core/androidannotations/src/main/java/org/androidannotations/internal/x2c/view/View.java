...
import org.androidannotations.internal.x2c.attr.*;
...
public class View implements ITranslator {
    ...
    private String autoBaseWidth = "", autoBaseHeight = "";
    ...
    private String generateView(Attributes attributes) {
        ...
        if (mParent != null) {
            ...
            stringBuilder.append(String.format("%s %s = new %s(%s,%s);\n", paramsName, mLayoutParamsObj
                    , paramsName, "ViewGroup.LayoutParams.MATCH_PARENT", "ViewGroup.LayoutParams.MATCH_PARENT"));
    ...
    private void getAutoLayoutAttribute() {
        if (mAttributes == null || (!autoBaseWidth.equals("") && !autoBaseHeight.equals(""))) {
            return;
        }
        String key;
        String value;
