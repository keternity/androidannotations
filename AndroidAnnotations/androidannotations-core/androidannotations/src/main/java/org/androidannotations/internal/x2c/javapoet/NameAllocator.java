 ...
 * 	&#64;code
 *
 * 	MethodSpec.Builder builder = MethodSpec.methodBuilder("toString").addAnnotation(Override.class).addModifiers(Modifier.PUBLIC).returns(String.class);
 *
...
public final class NameAllocator implements Cloneable {
	...
	/**
	 * Return a new name using {@code suggestion} that will not be a Java identifier
	 * or clash with other names.
	 */
	...
	/**
	 * Return a new name using {@code suggestion} that will not be a Java identifier
	 * or clash with other names. The returned value can be queried multiple times
	 * by passing {@code tag} to
	 */
