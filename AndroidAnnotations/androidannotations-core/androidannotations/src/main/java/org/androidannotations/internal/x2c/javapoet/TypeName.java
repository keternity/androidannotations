...
public class TypeName {
	...
	/**
	 * Returns true if this is a primitive type like {@code int}. Returns false for
	 * all other types types including boxed primitives and {@code void}.
	 */
	...
	/**
	 * Returns true if this is a boxed primitive type like {@code Integer}. Returns
	 * false for all other types types including unboxed primitives and
	 * {@code java.lang.Void}.
	 */
	public boolean isBoxedPrimitive() {
		return this.equals(BOXED_BOOLEAN) || this.equals(BOXED_BYTE) || this.equals(BOXED_SHORT) || this.equals(BOXED_INT) || this.equals(BOXED_LONG) || this.equals(BOXED_CHAR)
				|| this.equals(BOXED_FLOAT) || this.equals(BOXED_DOUBLE);
	}

	/**
	 * Returns a boxed type if this is a primitive type (like {@code Integer} for
	 * {@code int}) or {@code void}. Returns this type if boxing doesn't apply.
	 */
	public TypeName box() {
		if (keyword == null) {
	...
	/**
	 * Returns an unboxed type if this is a boxed primitive type (like {@code int}
	 * for {@code
	...
	static TypeName get(TypeMirror mirror, final Map<TypeParameterElement, TypeVariableName> typeVariables) {
		return mirror.accept(new SimpleTypeVisitor8<TypeName, Void>() {
			...
			public TypeName visitDeclared(DeclaredType t, Void p) {
				...
				return enclosing instanceof ParameterizedTypeName ? ((ParameterizedTypeName) enclosing).nestedClass(rawType.simpleName(), typeArgumentNames)
	...
	/**
	 * Returns the array component of {@code type}, or null if {@code type} is not
	 * an array.
	 */
